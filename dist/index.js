...
var useObject = function (data, assign) {
    var _a = react.useState(typeof assign === 'object' ? Object.assign(data, assign) : data), state = _a[0], setState = _a[1];
    return react.useMemo(function () { return ({
        state: state,
        setState: setState,
...
function useClient(onChange) {
    ...
    var memoChecker = react.useMemo(function () { return ({
...
function useScroll() {
    ...
    var toTop = react.useCallback(function () {
        if (!!inClient) {
            window.scrollTo(0, 0);
        }
    }, []);
...
function useLocalStorage(key, value) {
    ...
    var _a = react.useState(!!getItem ? JSON.parse(getItem) : JSON.stringify(value)), state = _a[0], setState = _a[1];
    react.useEffect(function () {
...
function useMiddleMouse(threshould) {
    ...
    if (!!inServer)
        return;
    var target = window;
    var _a = react.useState(0), direction = _a[0], setDirection = _a[1];
    var handleDirection = react.useCallback(function (_a) {
...
function useMouseIn(ref, callback) {
    ...
    if (inServer)
        return;
    var handleClick = react.useCallback(function (event) { return callback(ref.current && ref.current.contains(event.target)); }, [ref]);
    react.useEffect(function () {
...
function useDebounce(callback, timeout) {
    var _a = react.useState(callback), state = _a[0], setState = _a[1];
    react.useEffect(function () {
...
exports.useMiddleMouse = useMiddleMouse;
exports.useMouseIn = useMouseIn;
